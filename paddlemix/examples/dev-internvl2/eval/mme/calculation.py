...
eval_type_dict = {'Perception': ['existence', 'count', 'position', 'color',
...
class calculate_metrics:
    ...
    def compute_metric(self, gts, preds):
        ...
        fp, tn = conf_mat[1]
        metric_dict = dict()
        metric_dict = {'TP': tp, 'FN': fn, 'TN': tn, 'FP': fp, 'precision':
            precision, 'recall': recall, 'other_num': other_num, 'acc': acc}
        return metric_dict
            ...
            for task_name in task_name_list:
                ...
                for img_items in chunk_lines:
                    ...
                    for img_item in img_items:
                        try:
                            img_name, question, gt_ans, pred_ans = (img_item
                                .split('\t'))
                        except:
                            print(img_item)
                            continue
